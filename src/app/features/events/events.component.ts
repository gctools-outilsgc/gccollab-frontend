...
export class EventsComponent implements OnInit {
  ...
  upcomingEvents: Event[] = [
    ...
    new Event('2', 'Grillin n Chillin', 'https://images.unsplash.com/photo-1593871075120-982e042088d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1471&q=80', new Date(this.currentDate.getFullYear(), this.currentDate.getMonth(), this.currentDate.getDate() + 3), 'ESDC', new Location('4230 Innes Rd', 'Ottawa', 'Ontario')), // Three days from now
  ];
